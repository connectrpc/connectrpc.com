...
```javascript
fetch("https://demo.connectrpc.com/buf.connect.demo.eliza.v1.ElizaService/Say", {
  "method": "POST",
...
If you prefer a graphical user interface to explore an API, take a look at [Buf Studio](https://buf.build/studio/bufbuild/eliza/buf.connect.demo.eliza.v1.ElizaService/Say?target=https%3A%2F%2Fdemo.connectrpc.com&demo=true&share=s1Ks5lJQUCpOzStJzUtOVbJSUPJUSEtNzVHISCwoqNRT4qoFAA).

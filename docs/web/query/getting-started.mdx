...
Connect-Query is an expansion pack for [TanStack Query](https://tanstack.com/query) (react-query), written in TypeScript and thoroughly tested.  It enables effortless communication with servers over the [Connect Protocol](https://connect.build/docs/protocol) or the gRPC-Web Protocol.
...
The [code generator](https://www.npmjs.com/package/@bufbuild/protoc-gen-connect-query) does all the work of turning your Protobuf file into something you can easily import.  TypeScript types all populate out-of-the-box.  Your documentation is also converted to [TSDoc](https://tsdoc.org/).

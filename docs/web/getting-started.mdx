...
use [remote packages](https://buf.build/docs/bsr/remote-packages/overview), a feature of the Buf Schema Registry. The
...
$ npm install @buf/connectrpc_eliza.bufbuild_connect-es @connectrpc/connect @connectrpc/connect-web
```

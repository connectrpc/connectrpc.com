...
For some examples of customizing Fetch within Connect, take a look at our 
[Interceptors](./interceptors.mdx) docs. In addition, to see how to work with Fetch in an SSR context

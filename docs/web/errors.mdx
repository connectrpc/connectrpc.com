...
All errors are represented by [`ConnectError`](https://github.com/bufbuild/connect-es/blob/1c1dc4cfd300e120d07a486f488d5693139f9dee/packages/connect/src/connect-error.ts#L27),
...
All error codes are available through the TypeScript enumeration [`Code`](https://github.com/bufbuild/connect-es/blob/1c1dc4cfd300e120d07a486f488d5693139f9dee/packages/connect/src/code.ts#L16).

...
responses, support for [interceptors](/docs/swift/interceptors/),
...
[`GenerateAsyncMethods` option](/docs/swift/generating-code/#generation-options):
...
[`GenerateCallbackMethods` option](/docs/swift/generating-code/#generation-options):
...
[gzip-pool]: https://github.com/connectrpc/connect-swift/blob/main/Libraries/Connect/Public/Implementation/Compression/GzipCompressionPool.swift
[protocol-client-config]: https://github.com/connectrpc/connect-swift/blob/main/Libraries/Connect/Public/Interfaces/ProtocolClientConfig.swift

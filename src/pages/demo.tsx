      ...
      <div style={{ flexGrow: 1, padding: "15px" }}>
        ...
        >
          ...
          <p>
            ...
            <a href="https://github.com/connectrpc/examples-go">
              ELIZA demo service
            </a>
            , which is implemented in{" "}
            <a href="https://github.com/connectrpc/connect-go">connect-go</a>.
            <br />
            <br />
            This front-end client was built using{" "}
            <a href="https://github.com/connectrpc/connect-es">connect-web</a>,
            and you can follow{" "}
            <a href="/docs/web/getting-started">this guide</a> to implement it
            yourself.
            <br />
            <br />

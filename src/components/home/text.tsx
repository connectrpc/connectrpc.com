...
export const description = (
  <>
    ...
    HTTP APIs. If you&apos;re tired of hand-written boilerplate and turned off
    by massive frameworks, Connect is for you.
  </>
);
  ...
  },
  {
    ...
    description: (
      <>
        ...
        serialization, and compression, and it generates idiomatic clients in Go
        and TypeScript.
      </>
    ),
  },
